...
window.onload = function () {
	...
	if (parallax) {
		const content = document.querySelector('.main__wrapper')
		const image = document.querySelector('.main__img')
		const image1 = document.querySelector('.complete__img')
		const image2 = document.querySelector('.complete__img2')
		...
		function setMouseparallaxStyle() {
			...
			image1.style.cssText = `transform: translate(${positionX / forImage}%, ${
				positionY / forImage
			}%);`
			image2.style.cssText = `transform: translate(${-positionX / forImage}%, ${
				positionY / forImage
			}%);`
